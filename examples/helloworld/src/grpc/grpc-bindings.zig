...
pub const GRPC_UNUSED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:641:9
pub const GPR_PRINT_FORMAT_CHECK = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:649:9
pub const GPR_ALIGN_STRUCT = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:665:9
pub const GRPC_MUST_USE_RESULT = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:674:9
pub const GPR_HAS_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // grpc/include/grpc/support/port_platform.h:695:9
pub const GPR_ATTRIBUTE_NORETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:702:9
pub const GPR_UNREACHABLE_CODE = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // grpc/include/grpc/support/port_platform.h:718:9
pub const GPR_HAS_FEATURE = @compileError("unable to translate macro: undefined identifier `__has_feature`"); // grpc/include/grpc/support/port_platform.h:739:9
pub const GPR_ATTRIBUTE_NOINLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:747:9
pub const GPR_ATTRIBUTE_WEAK = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // grpc/include/grpc/support/port_platform.h:775:9
...
pub const GRPC_ARG_HAPPY_EYEBALLS_CONNECTION_ATTEMPT_DELAY_MS = "grpc.happy_eyeballs_connection_attempt_delay_ms";
